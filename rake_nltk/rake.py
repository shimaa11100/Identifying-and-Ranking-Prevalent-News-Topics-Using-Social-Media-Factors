...
class Rake(object):
    ...
    def __init__(
        ...
        #My comment isinstance(object,class)
        #if object in class then true else false
        ...
        #My comment chain used to mix two list in one list
        #Example: ()
    ...
    def _build_frequency_dist(self, phrase_list):
        ...
        """
        #Counter method return dictionary key is word value is frequency
    ...
    '''Remove stopwords, punctions and generate candidate keywords list '''
    ...
    def _get_phrase_list_from_words(self, word_list):
        ...
        """
        groups = groupby(word_list, lambda x: x not in self.to_ignore and len(x)>3)
